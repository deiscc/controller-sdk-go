...
COPY glide.yaml /go/src/github.com/deiscc/controller-sdk-go/
COPY glide.lock /go/src/github.com/deiscc/controller-sdk-go/

WORKDIR /go/src/github.com/deiscc/controller-sdk-go

RUN glide install --strip-vendor

COPY ./_scripts /usr/local/bin

COPY . /go/src/github.com/deiscc/controller-sdk-go
