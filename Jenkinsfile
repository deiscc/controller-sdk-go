...
// 	env.GOPATH = gopath
// 	def workdir = gopath + "\\src\\github.com\\deiscc\\controller-sdk-go"
//
...
def test_image = "quay.io/deiscc/controller-sdk-go-dev:${git_commit.take(7)}"
...
def wcli_image = 'quay.io/deiscc/workflow-cli-dev:latest'
...
node('linux') {
	...
	def pattern = "github\\.com\\/deiscc\\/controller-sdk-go\\n\\s+version:\\s+[a-f0-9]+"
	def replacement = "github\\.com\\/deiscc\\/controller-sdk-go\\n"
	...
	build_script += "&& rm -rf glide.lock vendor/github.com/deiscc/controller-sdk-go "
...
""", from: 'jenkins@ci.deis.cc', subject: 'Controller-sdk-go E2E Test Failure', to: env.SLACKEMAIL, mimeType: 'text/html'
			}
